...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            ...
            <hr>
            <p class="mt-4"><i>Embark on a journey towards professional success with <strong>Rozgar Sathi</strong>, your premier destination
              for connecting talent with opportunity.<p></i> At <strong>Rozgar Sathi</strong>, we understand that your career is more than just
              a job; it's a vital part of your life's journey. That's why we've created a dynamic and user-friendly
              platform to streamline your job search and empower you to reach new heights in your professional
              endeavors</p></p>
          </div>
          <div class="col-md-6">
  ...
  <footer class="footer py-3">
    <div class="container">
      <div class="col-12">&copy; 2023 - {{ config('app.name') }}</div>
    </div>
  </footer> <!-- /.footer -->
